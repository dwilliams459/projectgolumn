...
using PullRequest = PR.Ado.Core.Domain.PullRequests.PullRequest;
...
namespace PR.Ado.Core.Service
{
    public class PullRequestService
    {
        ...
        public async Task<List<PullRequest>> GetPullRequestsAssignedToMe(string username, int top = 10)
        {
            // https://dev.azure.com/PRDR/PR/_apis/
            string endpointQuery = $"git/pullrequests?searchCriteria.status=Active&$top={top}&api-version=6.0";
